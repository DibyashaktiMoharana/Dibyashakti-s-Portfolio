...
const SemiCircleCarousel = ({
  ...
  const projectWidth = 340; // Actual project component width

  return (
    <div className="relative w-full h-[260px] mx-auto overflow-hidden">
...
function Project({ imgURL, title }: { imgURL: string; title: string }) {
  return (
    <div className="w-[340px] aspect-[16/9] bg-gradient-to-br from-gray-800 via-gray-700 to-gray-900 border-2 border-[#303030] rounded-xl overflow-hidden shadow-md relative flex items-center justify-center">
      <Image
        src={imgURL}
        alt={title}
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 text-center">
        <h3 className="text-white text-base font-semibold drop-shadow-lg text-start">
          {title}
        </h3>
      </div>
    </div>
