...
const ExperienceCard = ({
  ...
  return (
    <motion.div
      ...
      className="w-full bg-[#1c1c1d]/80 backdrop-blur-sm rounded-2xl border-[2px] border-[#303030] p-4 md:p-6 hover:border-[#404040] transition-all duration-300 group"
    >
      ...
      <div className="block md:hidden space-y-1">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {employmentType && (
              <span className="px-2 py-1 bg-[#2a2a2a]/80 backdrop-blur-sm text-gray-400 text-xs rounded-full font-med">
                {employmentType}
              </span>
            )}
          </div>
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            className={`text-base font-sb transition-colors ${companyUrl
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
          <div className="flex-1">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-2 mb-2">
              <button
                onClick={handleCompanyClick}
                className={`text-lg font-sb transition-colors ${companyUrl
                  ? "text-blue-400 hover:text-blue-300 cursor-pointer"
                  : "text-gray-300"
                  }`}
              >
              ...
              {employmentType && (
                <span className="px-3 py-1 bg-[#2a2a2a]/80 backdrop-blur-sm text-gray-400 text-xs rounded-full font-med">
                  {employmentType}
                </span>
              )}
            </div>
